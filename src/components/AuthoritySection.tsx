        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              Sou designer gráfico especializado em criar identidades visuais que não apenas
              impressionam, mas que convertem. Cada projeto é tratado como único, com foco total
              em transmitir a essência da sua marca e gerar resultados.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <motion.div
                ...
                className="glass-card rounded-xl p-4 hover:border-primary/30">
