    ...
    <div className="container mx-auto px-4 md:px-8 pt-28 pb-20 relative z-10">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              className="group inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-primary text-primary-foreground font-semibold btn-glow hover:glow-box-strong transition-all duration-300"
            >
              Solicitar Orçamento
        ...
        >
          ...
          <div className="absolute -bottom-6 -left-6 w-40 h-40 rounded-full bg-primary/15 blur-[80px] animate-float" />
          <div className="absolute -top-6 -right-6 w-32 h-32 rounded-full bg-primary/10 blur-[60px] animate-float" style={{ animationDelay: '3s' }} />
        </motion.div>
      </div>
    </div>
  </section>
