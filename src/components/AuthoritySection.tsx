      ...
      <div className="container mx-auto" ref={ref}>
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">Sou designer gráfico especializado em criar identidades visuais que não apenas impressionam, mas que convertem. Cada projeto é tratado como único, com foco total em transmitir a  sua marca e gerar resultados.
